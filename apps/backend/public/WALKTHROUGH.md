...
- [Spice.Watch main] My List + Continue watching, synced to your SPICE account across devices: save films and series, resume the exact episode, mark watched, and sign in right from the browse pages. Same tables and endpoints the anime surface will reuse — no rebuild needed.
