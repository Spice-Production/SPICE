...
- [Spice.Movies main] Fancy frame: a shared sidebar + topbar with a profile menu (sign-in, account email, default watch source, sign-out) across movies and shows, a self-scrolling trending billboard with Play and My List on both homes, and a TV series spotlight on the movies landing.
